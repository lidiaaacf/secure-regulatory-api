...
MAX_DEPTH = 20
MAX_KEYS = 5000
DEFAULT_SENSITIVE_FIELDS = ["password", "token", "secret"]
...
def mask_sensitive_data(payload: Any, fields_to_mask: list[str] = None) -> Any:
    if fields_to_mask is None:
        fields_to_mask = DEFAULT_SENSITIVE_FIELDS
